 ...
 */
export function createAddAll({ repo, preload, options }: Context): (source: import("ipfs-core-types/src/utils").ImportCandidateStream, options?: any) => AsyncIterable<import("ipfs-core-types/src/root").AddResult>;
