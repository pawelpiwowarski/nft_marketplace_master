 ...
 */
export function createCp(context: MfsContext): (from: import("ipfs-core-types/src/utils").IPFSPath | import("ipfs-core-types/src/utils").IPFSPath[], to: string, opts?: any) => Promise<void>;
