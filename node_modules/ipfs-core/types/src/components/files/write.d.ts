 ...
 */
export function createWrite(context: MfsContext): (path: string, content: string | Uint8Array | AsyncIterable<Uint8Array> | Iterable<Uint8Array> | Blob, opts?: any) => Promise<void>;
