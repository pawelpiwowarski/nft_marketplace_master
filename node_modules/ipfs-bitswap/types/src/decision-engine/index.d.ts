export class DecisionEngine {
     ...
     */
    wantlistForPeer(peerId: PeerId): Map<string, import('../types/wantlist/entry').WantListEntry>;
    /**
     * @param {PeerId} peerId
     */
...
export type BitswapMessageEntry = import('../types/message/entry').BitswapMessageEntry;
