...
export namespace BitswapMessage {
     ...
     */
    export function deserialize(raw: Uint8Array, hashers?: Record<number, import("multiformats/hashes/interface").MultihashHasher> | undefined): Promise<BitswapMessage>;
    /**
     * @param {CID} cid
     */
