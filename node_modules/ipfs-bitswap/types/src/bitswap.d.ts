...
export class Bitswap extends BaseBlockstore implements IPFSBitswap {
     ...
     * @param {any} [_options]
     */
    wantlistForPeer(peerId: PeerId, _options?: any): Map<string, import("./types/wantlist/entry.js").WantListEntry>;
    /**
     ...
     */
    getWantlist(): IterableIterator<[string, import("./types/wantlist/entry.js").WantListEntry]>;
    /**
...
export type BitswapMessage = import('./types/message').BitswapMessage;
