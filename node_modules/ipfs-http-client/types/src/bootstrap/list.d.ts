 ...
 */
export const createList: import("../lib/configure.js").Factory<(options?: (import("ipfs-core-types/src/utils").AbortOptions & import("../types").HTTPClientExtraOptions) | undefined) => Promise<{
    Peers: Multiaddr[];
}>>;
