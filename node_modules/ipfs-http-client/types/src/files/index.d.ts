...
export function createFiles(config: import('../types').Options): {
    ...
    write: (path: string, input: string | Uint8Array | Blob | Iterable<Uint8Array> | AsyncIterable<Uint8Array>, options?: (import("ipfs-core-types/src/files").WriteOptions & import("../types").HTTPClientExtraOptions) | undefined) => Promise<void>;
};
